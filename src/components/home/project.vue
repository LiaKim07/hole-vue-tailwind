<template>
  <section id="project" class="bg-color-secondary relative">
    <div>
      <h1 class="text-5xl font-semibold uppercase text-center pt-10 w-full">
        Project
      </h1>
    </div>
    <div class="flex flex-col md:flex-row items-center justify-around">
          ...
          >
            <g id="main-logo" transform="translate(673, 673)">
              ...
              <g
                ...
                @click="$refs.vueperslides2.goToSlide(0)"
              >
                <circle
                  class="dot2"
                  id="Ellipse 28"
                ...
                <circle
                  class="dot"
                  :style="
                    projectJSON[0].description ? 'fill:black' : 'fill:grey'
                  "
                  id="Ellipse 24"
                  cx="0"
                  cy="0"
              ...
              <g
                ...
                @click="$refs.vueperslides2.goToSlide(1)"
              >
                <circle
                  class="dot2"
                  id="Ellipse 28"
                ...
                <circle
                  class="dot"
                  :style="
                    projectJSON[1].description ? 'fill:black' : 'fill:grey'
                  "
                  id="Ellipse 24"
                  cx="0"
                  cy="0"
              ...
              <g
                ...
                @click="$refs.vueperslides2.goToSlide(2)"
              >
                <circle
                  class="dot2"
                  id="Ellipse 28"
                ...
                <circle
                  class="dot"
                  :style="
                    projectJSON[2].description ? 'fill:black' : 'fill:grey'
                  "
                  id="Ellipse 24"
                  cx="0"
                  cy="0"
              ...
              <g
                ...
                @click="$refs.vueperslides2.goToSlide(3)"
              >
                <circle
                  class="dot2"
                  id="Ellipse 28"
                ...
                <circle
                  class="dot"
                  :style="
                    projectJSON[3].description ? 'fill:black' : 'fill:grey'
                  "
                  id="Ellipse 24"
                  cx="0"
                  cy="0"
              ...
              <g
                ...
                @click="$refs.vueperslides2.goToSlide(4)"
              >
                <circle
                  class="dot2"
                  id="Ellipse 28"
                ...
                <circle
                  class="dot"
                  :style="
                    projectJSON[4].description ? 'fill:black' : 'fill:grey'
                  "
                  id="Ellipse 24"
                  cx="0"
                  cy="0"
              ...
              <g
                ...
                @click="$refs.vueperslides2.goToSlide(5)"
              >
                <circle
                  class="dot2"
                  id="Ellipse 28"
                ...
                <circle
                  class="dot"
                  :style="
                    projectJSON[5].description ? 'fill:black' : 'fill:grey'
                  "
                  id="Ellipse 24"
                  cx="0"
                  cy="0"
      ...
      <div
        class="flex flex-col text-center mx-auto"
        style="width: 100%; max-width: 700px"
      >
        <!-- <h4 class="text-2xl mb-6 text-color-dark">{{ projectName }}</h4>
        <p class="font-semibold whitespace-pre-wrap text-color-dark">
          {{ projectDesc }}
        </p> -->
        <!-- <button
          class="
...
import "./project.css";
// import logoMedium from "../common/logo-medium.vue";
export default {
  ...
  methods: {
    detail(value) {
      ...
      this.projectDesc = value.description;
    },
    animated() {
      this.$nextTick(() => {
        setInterval(() => {
  ...
  created() {
    ...
    this.projectName = this.projectJSON[0].name;
    this.projectDesc = this.projectJSON[0].description;
  },
};
</script>
